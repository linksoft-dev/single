...
export class StringRules extends jspb.Message {
  ...
  getRequired(): StringRequired | undefined;
  setRequired(value?: StringRequired): StringRules;
  hasRequired(): boolean;
  clearRequired(): StringRules;
...
export namespace StringRules {
  export type AsObject = {
    ...
    strict?: boolean,
    ignoreEmpty?: boolean,
    required?: StringRequired.AsObject,
  }
...
export class StringRequired extends jspb.Message {
  getMinLen(): number;
  setMinLen(value: number): StringRequired;

  getMaxLen(): number;
  setMaxLen(value: number): StringRequired;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): StringRequired.AsObject;
  static toObject(includeInstance: boolean, msg: StringRequired): StringRequired.AsObject;
  static serializeBinaryToWriter(message: StringRequired, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): StringRequired;
  static deserializeBinaryFromReader(message: StringRequired, reader: jspb.BinaryReader): StringRequired;
}

export namespace StringRequired {
  export type AsObject = {
    minLen: number,
    maxLen: number,
  }
